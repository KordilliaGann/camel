...
void camelC(char cchoice, bool& done)
{
	...
	if(cchoice == 'A')
	{
    	cout << "You quickly unload your gun on the figure, but you quickly notice that there's nothing there." << endl;
    	...
    	cout << "You try running away but the natives are too quick for you, so they capture you and turn you into their slave." << endl;
	}
	if(cchoice == 'B')
	{
    	cout << "You close your eyes for a short time. Once you open your eyes, you noticed that there's nothing there." << endl;
    	cout << "You look out into the distance to find the natives heading back to where they came from. The natives finally gave up trying to find you." << endl;
